...
interface InternetRadioStationContextMenuProps {
    items: InternetRadioStation[];
    type: LibraryItem.RADIO_STATION;
}

export const InternetRadioStationContextMenu = ({
    items,
    type,
    ...
    const canDeleteRadio = permissions.radio.delete;

    return (
        <ContextMenu.Content
            bottomStickyContent={<ContextMenuPreview items={items} itemType={type} />}
        >
            <PlayRadioAction stations={items} />
            <ContextMenu.Divider />
            <EditRadioAction disabled={!canEditRadio} items={items} />
            <DeleteRadioAction disabled={!canDeleteRadio} items={items} />
            <ContextMenu.Divider />
