...
export const NDSongQueryFields = [
    ...
    { label: 'Album Date Added', type: 'date', value: 'albumdateadded' },
    { label: 'Album Date Modified', type: 'date', value: 'albumdatemodified' },
    { label: 'Album Duration', type: 'number', value: 'albumduration' },
    { label: 'Album Song Count', type: 'number', value: 'albumsongcount' },
    { label: 'Album Size', type: 'number', value: 'albumsize' },
...
const albumArtist = z.object({
    ...
    id: z.string(),
    imageAbsent: z.boolean().optional(),
    ...
    name: z.string(),
    orderArtistName: z.string().optional(),
...
const disc = z.record(z.string(), z.string());

const album = z.object({
    albumArtist: z.string(),
    albumArtistId: z.string(),
    allArtistIds: z.string().optional(),
    ...
    externalInfoUpdatedAt: z.string().nullable(),
    externalUrl: z.string().optional(),
    fullText: z.string().optional(),
    genre: z.string(),
    ...
    sortAlbumArtistName: z.string().optional(),
    sortAlbumName: z.string().optional(),
    sortArtistName: z.string().optional(),
    starred: z.boolean().optional(),
    starredAt: z.string().optional(),
...
const song = z.object({
    ...
    rgAlbumGain: z.number().optional().nullable(),
    rgAlbumPeak: z.number().optional().nullable(),
